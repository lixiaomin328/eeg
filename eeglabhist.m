% EEGLAB history file generated on the 11-Sep-2019
% ------------------------------------------------

EEG.etc.eeglabvers = 'development head'; % this tracks which version of EEGLAB is being used, you may ignore it
EEG = pop_biosig('/Volumes/colin/eeg_poker/16_EEG');
EEG.setname='16BDF file';
...
EEG.setname='16aBDF file';
EEG = pop_loadset('filename','16a.set','filepath','/Volumes/colin/EEG_data/');
EEG = eeg_checkset( EEG );
pop_eegplot( EEG, 1, 1, 1);
EEG = pop_editeventvals(EEG,'delete',1,'delete',1);
EEG = eeg_checkset( EEG );
EEG = pop_loadset('filename','16a.set','filepath','/Volumes/colin/eegResampled/');
EEG = eeg_checkset( EEG );
